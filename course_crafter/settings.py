...
SECRET_KEY = 'django-insecure-!re=#xew1@c5$t3=-7sb#+6=e@4tzudc3dhoaf=at1zkt6+2#e'
...
SIMPLE_JWT = {
    ...
    "BLACKLIST_AFTER_ROTATION": False,          #  TODO --------------
...
ROOT_URLCONF = 'course_crafter.urls'
...
WSGI_APPLICATION = 'course_crafter.wsgi.application'
...
# DATABASES = {
#     'default': {
#         'ENGINE': 'django.db.backends.dummy',  # Use a dummy engine since we are using PyMongo directly
#         'NAME': 'your_db_name',  # Replace with your actual database name
#         'CLIENT': pymongo.MongoClient(
#             'mongodb://root:Hareessh1*@localhost:27017/',  # Adjust connection details
#             authSource='admin',
